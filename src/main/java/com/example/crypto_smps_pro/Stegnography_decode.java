...
public class Stegnography_decode extends AppCompatActivity implements TextDecodingCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stegnography_decode);

        //Instantiation of UI components
        textView = findViewById(R.id.whether_decoded1);
        ...
        decode_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (filepath != null) {
                    ...
                    TextDecoding textDecoding = new TextDecoding(Stegnography_decode.this, Stegnography_decode.this);
